...
/// 空空码上点单数据库上下文
/// </summary>
public partial class ByteBiteDbContext : DbContext
{
    public ByteBiteDbContext(DbContextOptions<ByteBiteDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasMany(e => e.DataMergeLogSourceCustomers)
                .WithOne(d => d.SourceCustomer)
                .HasForeignKey(d => d.SourceCustomerId)
                .OnDelete(DeleteBehavior.Restrict)
                .HasConstraintName("fk_data_merge_logs_source_customer");

            entity.HasMany(e => e.DataMergeLogTargetCustomers)
                .WithOne(d => d.TargetCustomer)
        ...
        modelBuilder.Entity<CustomerSession>(entity =>
        {
            ...
            entity.ToTable("customer_sessions", tb => tb.HasComment("顾客会话表"));
        ...
        modelBuilder.Entity<DataMergeLog>(entity =>
        {
            ...
            entity.ToTable("data_merge_logs", tb => tb.HasComment("数据合并日志表"));
        ...
        modelBuilder.Entity<ProductSalesStat>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.StoreId, e.ProductId, e.StatDate }, "uq_product_sales_stats_store_product_date").IsUnique();
        ...
        modelBuilder.Entity<CustomerConsumptionStat>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.StoreId, e.CustomerId, e.DeviceId }, "uq_customer_consumption_stats_store_customer_device").IsUnique();
        ...
        modelBuilder.Entity<HourlyOrderStat>(entity =>
        {
            ...
            entity.ToTable("hourly_order_stats", tb => tb.HasComment("时段订单统计表"));

            entity.HasIndex(e => new { e.StoreId, e.StatDate, e.Hour }, "uq_hourly_order_stats_store_date_hour").IsUnique();
        ...
        modelBuilder.Entity<DiscountEffectStat>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.DiscountRuleId, e.StatDate }, "uq_discount_effect_stats_rule_date").IsUnique();

            entity.Property(e => e.Id)
                .HasDefaultValueSql("gen_random_uuid()")
                .HasColumnName("id");
            entity.Property(e => e.DiscountRuleId)
        ...
        modelBuilder.Entity<SystemConfig>(entity =>
        {
            ...
            entity.HasIndex(e => e.ConfigKey, "uq_system_configs_config_key").IsUnique();
        ...
        modelBuilder.Entity<PlatformDailyStat>(entity =>
        {
            ...
            entity.HasIndex(e => e.StatDate, "uq_platform_daily_stats_stat_date").IsUnique();
